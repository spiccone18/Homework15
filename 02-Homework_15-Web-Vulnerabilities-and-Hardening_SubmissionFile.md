...
Answer: The File Path. The name of the attack used is a Directory Traversal 
   
3. Name three threat agents that can pose a risk to your organization.

Answer: Indivuals, Organizations or governments

4. What kinds of sources can act as an attack vector for injection attacks?

Answer: Poor encryption, lazy code code (html), misconfigurations
...
Answer: Developer Error, Cost, Failure in Security systems being relied on 

4. How might an attacker exploit the `robots.txt` file on a web server?

Answer: Robots.txt manages access controls about which pages/files are available to search enginer crawlers. This can be exploited to find the conent management system and the structure of the directories. 

5. What steps can an organization take to obscure or obfuscate their contact information on domain registry web sites?

Answer: An org. can utilize a proxy service or private domain registration. 
   
6. True or False: As a network defender, `Client-Side` validation is preferred over `Server-Side` validation because it's easier to defend against attacks.

   - Explain why you chose the answer that you did.

Answer: False. Cleint-side validation can be manipulated more easily because of its external-facing nature. 
...
1. Define all four factors of multifactor authentication and give examples of each:
   ...
   - Factor 1: Standara login inputs: Password, PIN

   
   - Factor 2: Physical Keys: ID CArd, Door Key 
   
   
   - Factor 3: Biometrics: Facial Recognition, Fingerprint, Iris Scan

   
   - Factor 4: Location: GPS 

   
2. True or False: A password and pin is an example of 2-factor authentication.

Answer: False. Must be 2 different factors of auth.
...
Answer: An interface that is restrice based on privleges. 
...
Please include a screenshot here of the hidden JavaScript: "youaretheweakestlink" and "goodbye"

Screen Shot 2020-12-07 at 7.32.54 PM
...
Screen Shot 2020-12-10 at 4.17.40 PM
